...
// import { Github, Twitter, Linkedin } from "../../../static/icons";
...
const AuthorCard = ({ author, className }) => {
  ...
  return (
    <div
      className={clsx("blog-post-item-shadow rounded-[10px] p-4", className)}
    >
      <figcaption className="flex flex-col items-center">
        ...
        <div className="mt-2 text-center">
          ...
          <div className="-mt-0.5 text-xs text-[#9696B4] ">{author?.title}</div>
